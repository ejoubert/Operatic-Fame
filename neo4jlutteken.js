...
function neo4jLüttekenExport(lüttekenArr) {
  for (let i = 0; i < lüttekenArr.length; i++) {
    ...
    //MERGE (n:Person {Critic:"'+reorderName(airtableArr[i][7])+'", Composer:"'+airtableArr[i][9]+'", Troupe_Director:"'+airtableArr[i][19]+'", Theatre_Director:"'+airtableArr[i][20]+'", Performer:"'+airtableArr[i][21]+'", Ruler:"'+airtableArr[i][22]+'", Aesthetician:"'+airtableArr[i][23]+'", Diplomat:"'+airtableArr[i][24]+'", Librettist:"'+airtableArr[i][25]+'"})
    //MERGE (s:Place {Country: "'+airtableArr[i]+'", City: "'+airtableArr[i]+'", Court:"'+airtableArr[i]+'", Theatre: "'+airtableArr[i]+'"})

    //MERGE (n:Person {Critic:"'+reorderName(lüttekenArr[i][7])+'"})
    session
    .run(query)
    .then(function (result) {
